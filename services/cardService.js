...
const getCardBySetNameAndNumber = async (setName, cardNumber, token) => {
    const response = await axiosService.get(`/v1/cards?setName=${setName}&cardNumber=${cardNumber}`, {
        headers: {
            Authorization: `Bearer ${token}`
        }
    })
...
module.exports = { getCardByCriteria, getCardsByYear, getCardBySetNameAndNumber }